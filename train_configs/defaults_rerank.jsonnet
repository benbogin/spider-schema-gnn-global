...

{
  "dataset_reader": {
    ...
    "sub_graphs_candidates_path": "experiments/experiment/candidates_train.json",
  },
  "validation_dataset_reader": {
    ...
    "max_candidates": 10,
    "sub_graphs_candidates_path": "experiments/experiment/candidates_dev.json"
  },
  ...
  "trainer": {
    ...
    "cuda_device": 0,
    "patience": 100,
    "validation_metric": "+query_accuracy",
    "optimizer": {
      "type": "adam",
      "lr": 0.001,
      "weight_decay": 5e-4
